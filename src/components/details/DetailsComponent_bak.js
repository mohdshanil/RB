...
import { Row, Col, Card, CardImg, CardText, CardBody, CardTitle, CardSubtitle, Button, Container, Form, FormGroup, Label, Input, Badge, InputGroup, InputGroupAddon, InputGroupText, CardHeader, CardFooter } from 'reactstrap';
...
export default connect(detailMapStateToProps, detailDispatchToProps)(DetailsComponent);